...
METHOD = 'DELETE'
# Get user id from get_all_users.py output
USER_ID = ''
# Get phone id from get_all_phones.py output
PHONE_ID = ''
API_PATH = '/admin/v1/users/{}/phones/{}'.format(USER_ID, PHONE_ID)
PARAMS = {}
...
association = requests.request(METHOD, url, data=body, headers=request_headers, verify=False)

pprint.pprint(json.loads(association.content))