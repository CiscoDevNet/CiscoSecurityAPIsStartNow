...
url = "https://{}{}".format(API_HOSTNAME, API_PATH, USERNAME)
...
users = requests.request(METHOD, url, data=body, headers=request_headers, verify=False)
